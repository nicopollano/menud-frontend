  ...
  BUSINESSES: {
    ...
    BRANCHES: {
      ...
      BRANCH: {
        ...
        COPY: (businessId: string, branchId: string) =>
          `${API_URL}/v1/public/businesses/${businessId}/branches/${branchId}/copy`,
        MOVE: (businessId: string, branchId: string) =>
          `${API_URL}/v1/public/businesses/${businessId}/branches/${branchId}/move`
      },
      SCHEDULES: {
        BASE: (businessId: string, branchId: string) =>
      ...
      MENUS: {
        ...
        MENU: {
          ...
          COPY: (businessId: string, branchId: string, menuId: string) =>
            `${API_URL}/v1/public/businesses/${businessId}/branches/${branchId}/menus/${menuId}/copy`,
          MOVE: (businessId: string, branchId: string, menuId: string) =>
            `${API_URL}/v1/public/businesses/${businessId}/branches/${branchId}/menus/${menuId}/move`
        }
      },
      PALETTES: {
        BASE: (businessId: string, branchId: string) =>
