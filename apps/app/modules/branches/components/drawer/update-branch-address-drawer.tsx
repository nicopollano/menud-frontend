...
interface UpdateBranchAddressDrawerProps {
  branch: Branch
  children: React.ReactNode
}

function UpdateBranchAddressDrawer({ branch, children }: UpdateBranchAddressDrawerProps) {
          ...
          >
            ...
            <DrawerHeader className='gap-y-[1.875rem]'>
              <div className='grid gap-y-2.5'>
                <DrawerTitle>Dirección</DrawerTitle>
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormGroup>
                      ...
                      <FormLabel variant='field'>Dirección</FormLabel>
                    </FormGroup>
                    <FormMessage />
                  </FormItem>
                )}
            ...
            <DrawerFooter>
              <Button type='submit' size='medium' disabled={isSubmitting || !!(!isDirty && branch.address)}>
...
export { UpdateBranchAddressDrawer }
