...
interface UpdateBranchNameDrawerProps {
  branch: Branch
  children: React.ReactNode
}

function UpdateBranchNameDrawer({ branch, children }: UpdateBranchNameDrawerProps) {
          ...
          >
            ...
            <DrawerHeader className='gap-y-[1.875rem]'>
              <div className='grid gap-y-2.5'>
                <DrawerTitle>Nombre</DrawerTitle>
